...
export class JobSubmission extends jspb.Message {
  ...
  hasParamsDict(): boolean;
  clearParamsDict(): void;
  getParamsDict(): google_protobuf_struct_pb.Struct | undefined;
  setParamsDict(value?: google_protobuf_struct_pb.Struct): void;
...
export namespace JobSubmission {
  export type AsObject = {
    ...
    workflowType: string,
    esdl: string,
    paramsDict?: google_protobuf_struct_pb.Struct.AsObject,
  }
}
